...
describe('Text styling', () => {
  ...
  describe('customizable items', () => {
    ...
    it('styles scenario keywords', async () => {
      ...
      result.should.containEql(
        `${styleText('[-id-] Scenario:', 'bgYellow')} Scenario name`
      )
    })
    ...
    it('styles scenario names', async () => {
      ...
      result.should.containEql(
        `  [-id-] Scenario: ${styleText('Scenario name', 'bgMagenta')}`
      )
    })
    ...
    it('styles step keywords', async () => {
      ...
      result.should.containEql(
        `    ${styleText('[-id-] Given', ...stepStyles)} noop\n` +
          `    ${styleText('[-id-] When', ...stepStyles)} noop\n` +
          `    ${styleText('[-id-] Then', ...stepStyles)} noop\n`
      )
    })
  ...
  describe('default theme', () => {
    ...
    it('styles scenario keywords', () =>
      runResult.should.containEql(
        styleText('[-id-] Scenario:', 'cyan', 'bold')
      ))
    ...
    it('styles step keywords', () => {
      runResult.should.containEql(styleText('[-id-] Given', 'cyan'))
      runResult.should.containEql(styleText('[-id-] When', 'cyan'))
      runResult.should.containEql(styleText('[-id-] Then', 'cyan'))
    })
